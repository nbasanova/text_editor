...
public class NearbyWords implements SpellingSuggest {
	...
	public List<String> suggestions(String word, int numSuggestions) {
		...
		while((!queue.isEmpty())&&(retList.size()<numSuggestions)&&(wordCount<THRESHOLD)) {
			...
			wordCount++;
			List<String> currNeighbors = new LinkedList<String>();
			substitution(curr, currNeighbors, true);
			insertions(curr, currNeighbors, true);
			deletions(curr, currNeighbors, true);
			for(String n: currNeighbors) {
